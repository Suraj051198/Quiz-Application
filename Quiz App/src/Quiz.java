...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        ImageIcon i1 = new ImageIcon("C:\\Users\\suraj\\OneDrive\\Desktop\\java P\\Quiz App\\img\\quiz.jpg");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            setVisible(false);
            new Score(name, score); // Corrected line
        }
    }

    // Corrected method name from `pain pain(Graphics g)` to `paint(Graphics g)`
    @Override
